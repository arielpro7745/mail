...
כדי למסור את התעודה, אני צריך את קוד המסירה בן 4 הספרות שקיבלת:
📱 בהודעת SMS מרשות האוכלוסין
📄 או בדף שקיבלת כשהיית במשרד

אנא שלח לי את הקוד ואגיע למסירה.
...
כדי למסור את החבילה, אני צריך את הפרטים הבאים:

🏢 קומה: ___
🚪 מספר דירה: ___
🔑 קוד כניסה לבניין: ___
📍 האם להניח ליד הדלת? כן/לא

אנא שלח לי את הפרטים ואגיע למסירה.
