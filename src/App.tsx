...
const SCHEDULE_16_DAYS = [
  ...
  { day: 2, area: 14, title: "רוטשילד זוגי (14א)", color: "red", streets: ["גד מכנס", "רוטשילד", "הדף היומי"], tips: "גד מכנס 4 (בית אבות) קודם! אח\"כ רוטשילד זוגי (110-182) והדף היומי." },
  ...
  { day: 7, area: 14, title: "רוטשילד אי-זוגי (14ב)", color: "red", streets: ["רוטשילד", "קק\"ל", "קרן קיימת"], tips: "רוטשילד 179-143, אח\"כ קק\"ל, ואז רוטשילד 141-109." },
