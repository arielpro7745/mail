...
const SCHEDULE_16_DAYS = [
  // יום 1 - אזור 45 - היבנר (הכבד ביותר)
  { day: 1, area: 45, title: "היבנר", color: "blue", streets: ["היבנר"], tips: "יום כבד! 20 בניינים + 10 בתים בזוגי, 15 בניינים + 7 בתים באי-זוגי." },
  
  // יום 2 - אזור 14 - רוטשילד זוגי
  { day: 2, area: 14, title: "רוטשילד זוגי", color: "red", streets: ["הדף היומי", "רוטשילד 110-132", "רוטשילד 136-150", "רוטשילד 152-182", "גד מכנס 4"], tips: "הדף היומי → רוטשילד 110-132 → 136-150 → 152-182 → גד מכנס 4 (בית אבות בסוף!)" },
  ...
  // יום 7 - אזור 14 - רוטשילד אי-זוגי
  { day: 7, area: 14, title: "רוטשילד אי-זוגי", color: "red", streets: ["רוטשילד 179-143", "קק\"ל זוגי", "קק\"ל אי-זוגי", "רוטשילד 141-109"], tips: "רוטשילד 179-143 → קק\"ל זוגי → קק\"ל אי-זוגי → רוטשילד 141-109" },
  ...
  // יום 10 - אזור 12 - זכרון משה + הכרם
  { day: 10, area: 12, title: "זכרון משה + הכרם", color: "green", streets: ["זכרון משה", "הכרם"], tips: "זכרון משה: 20 בניינים. הכרם: 8 בניינים." },
  
  // יום 11 - אזור 45 - ברטונוב + סנדרוב
  { day: 11, area: 45, title: "ברטונוב + סנדרוב", color: "blue", streets: ["ברטונוב", "סנדרוב"], tips: "ברטונוב: 9 בניינים. סנדרוב: 4 בניינים." },
  
  // יום 12 - אזור 12 - חפץ מרדכי + האחים ראב
  { day: 12, area: 12, title: "חפץ מרדכי + ראב", color: "green", streets: ["חפץ מרדכי", "האחים ראב"], tips: "חפץ מרדכי: 19 בניינים. האחים ראב: 8 בניינים." },
  
  // יום 13 - אזור 45 - מרטין בובר + שטרן
  { day: 13, area: 45, title: "מרטין בובר + שטרן", color: "blue", streets: ["מרטין בובר", "שטרן"], tips: "מרטין בובר: 20 בתים. שטרן: 7 בתים. יום קל!" },
  ...
  // יום 15 - אזור 45 - מירקין + הפרטיזנים
  { day: 15, area: 45, title: "מירקין + הפרטיזנים", color: "blue", streets: ["מירקין מרדכי", "הפרטיזנים"], tips: "מירקין: 1 בניין + 11 בתים. הפרטיזנים: 14 בתים. יום קל!" },
